...
<div>
    ...
    <form action="/index.php/Admin/Chat/index" >
    ...
    $(document).ready(function () {
        ...
        $('.add').click(function () {
            ...
            var index = layer.open({
                ...
                area: ['85vw', '85vh'],
                fix: false, //不固定
                content: '/index.php/Admin/Chat/add/',
                btn: ['确定', '关闭'],
                yes: function () {
                    var form = layer.getChildFrame('form', index);
                    $.post('/index.php/Admin/Chat/add', form.serialize(), function (data) {
                        if (data.status == 1) {
                            layer.msg(data.msg, {
                                time: 2000,
                                end: function () {
        ...
        $('.save').click(function () {
            ...
            var index = layer.open({
                ...
                area: ['85vw', '85vh'],
                fix: false, //不固定
                content: '/index.php/Admin/Chat/save/id/' + id,
                yes: function () {
                    var form = layer.getChildFrame('form', index);
                    $.post('/index.php/Admin/Chat/save', form.serialize(), function (data) {
                        if (data.status == 1) {
                            layer.msg(data.msg, {
                                time: 2000,
                                end: function () {
        ...
        $('.del').click(function () {
            ...
            var index = layer.msg('是否删除' + title + '? <br>删除后不可恢复，请谨慎操作！', {
                ...
                yes: function () {
                    layer.close(index);
                    $.post('/index.php/Admin/Chat/del', {id: id, title:title}, function (data) {
                        if (data.status == 1) {
                            layer.msg(data.msg, {
        ...
        $('.disable_data').click(function () {
            var title = $(this).data('name');
            var id = $(this).data('id');
            $.post('/index.php/Admin/Chat/disable_data', {id: id}, function (data) {
                if (data.status == 1) {
                    layer.msg(data.msg, {
                        time: 1000, end: function () {
                            window.location.reload();
        ...
        $('.view').click(function () {
            ...
            var index = layer.open({
                ...
                area: ['85vw', '85vh'],
                fix: false, //不固定
                content: '/index.php/Admin/Chat/view/id/' + id,
                btn: [ '关闭'],
                yes: function () {
                    layer.close(index);
                }
